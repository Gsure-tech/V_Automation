...
describe("LLC Registration API Flow", () => {
    ...
    // 4. REGISTER AFFILIATE - CORPORATE 1st
    it("should register a corporate affiliate using the same transactionRef AS 1st Affiliate", () => {
        cy.api({
            method: "POST",
