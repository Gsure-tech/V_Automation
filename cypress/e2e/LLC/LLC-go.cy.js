...
describe("LLC Registration API Flow", () => {
  ...
  let stampDutyPaymentUrl;
    ...
    it("should check compliance using the proposedName", () => {
        ...
        cy.api({
            ...
            url: `${baseUrl}/api/vas/llc-go/compliance`,
  ...
  it("should return 200 and reservation details when a unique proposedName is submitted", () => {
    ...
    cy.api({
      method: "POST",
      url: `${baseUrl}/api/vas/llc-go/name-reservation`,
      headers: HEADERS.VALID_API_KEY,
      body: {
        proposedName,
  ...
  //   cy.api({
  //     method: "POST",
  //     url: `${baseUrl}/api/vas/llc-go/company`,
  //     headers: HEADERS.VALID_API_KEY,
  //     failOnStatusCode: false,
  //     body: {
  ...
  it("should register share details using the same transactionRef", () => {
    cy.api({
      method: "POST",
      url: `${baseUrl}/api/vas/llc-go/shares`,
      headers: HEADERS.VALID_API_KEY,
      body: {
        transactionRef,
  ...
  it("should register an individual affiliate using the same transactionRef AS 1st Affiliate", () => {
    cy.api({
      method: "POST",
      url: `${baseUrl}/api/vas/llc-go/affiliates`,
      headers: HEADERS.VALID_API_KEY,
      body: {
  ...
  //   cy.api({
  //     method: "POST",
  //     url: "http://41.207.248.246:9088/api/vas/llc-go/affiliates",
  //     headers: HEADERS.VALID_API_KEY,
  //     body: {
  //       transactionRef: transactionRef,
  //       corporate: {
...
it("should add a person with significant control (PSC) 1", () => {
  cy.api({
    method: "POST",
    url: `${baseUrl}/api/vas/llc-go/psc`,
    headers: HEADERS.VALID_API_KEY,
    body: {
      transactionRef: transactionRef,
...
it("should successfully submit the company registration", () => {
  cy.api({
    method: "POST",
    url: `${baseUrl}/api/vas/llc-go/register`,
      // qs: {
...
// FINAL STEP: CHECK REGISTRATION STATUS
    it("should successfully check the status of the registration using the current transactionRef", () => {
        ...
        cy.api({
            method: 'GET',
            url: `${baseUrl}/api/vas/llc-go/status/${transactionRef}`,
            headers: HEADERS.VALID_API_KEY
        }).then((response) => {
