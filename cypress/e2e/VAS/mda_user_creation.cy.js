describe('mda Creation Flow', () => {
    it('should login and successfully create an mda', () => {
        ...
        cy.get(':nth-child(3) > .input-group > .form-control').select('MDA USER');
        cy.get('.btn').contains('Send Invite').click({force:true});
        cy.get('.success-card').contains('success');
        cy.get('.message-title-body').contains('MDA link was successfully sent');
